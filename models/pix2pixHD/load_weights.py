...
core_generator.model.load_weights(weights_path + "core_generator.h5")
enhancer.model.load_weights(weights_path + 'enhancer.h5')
discriminator_full.model.load_weights(weights_path + 'discriminator_full.h5')
discriminator_low.model.load_weights(weights_path + 'discriminator_low.h5')
style_features.model.load_weights(weights_path + 'style_features.h5')
