...
class CoreGenerator():
    ...
    def __init__(self,
        ...
        core_generator_idea = Input(
            shape=(self.width, self.height, self.input_channels,))
        core_generator_idea_downsample = AvgPool2D(
            2, padding='same')(core_generator_idea)

        core_generator_style = Input(
            shape=(self.width/(2**7), self.height/(2**7), self.input_channels,))
        ...
        core_generator = Model([core_generator_idea, core_generator_style], [
                               picture_lowres, features])
